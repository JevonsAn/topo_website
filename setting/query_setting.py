...
action_union = {"all", "edge_table", "ip", "single", "router_link", "router_node", "router_appear", "equal_router",
                "pop_topo_link", "pop_topo_node"}
type_union = {}
...
action_type_to_tablename = {
    ...
    "gateway": {
        "node": "gateway_node_table",
        "edge": "gateway_edge_table"
    }
}
